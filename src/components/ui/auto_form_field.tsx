...
export function AutoFormField<T extends FormFields<T>, S extends Schema>(props: {
    field: T;
    resourceSchema?: S;
    submit: () => Promise<void>
    ...
    return (<Field.Root invalid={!!errors[field.name]} required key={field.id}>
        <Field.Label>
